...
This plan covers optional capture and historical recall only. Mandatory project startup facts use the separate launch-scoped path in [[2026-07-19-agentcairn-memory-integration-project-brief]] and do not depend on Stage 2.
