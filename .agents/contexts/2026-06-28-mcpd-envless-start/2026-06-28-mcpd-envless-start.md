...
updated: 2026-06-28
status: active
next: change the mcpproxy startup path so `mcpd` no longer sources `~/.mcpproxy/env`; design a portable KeePass-backed wrapper before editing launchd or `bin/mcpd`
---
# mcpd envless start
...
- [[2026-06-28-mcp-stack-plan-v2]] - older/current MCP stack plan; still mentions env sourcing and should be updated when implementation happens.
...
- [[2026-06-21-mcp-stack]] — родительский дизайн стека
- [[2026-06-21-dotfiles-access-audit]] — обращение с секретами проверяется там
