...
name: oc-maintenance
description: >-
  Maintain and troubleshoot OpenCode configuration, skills, plugins, MCP
  servers, and related dotfiles. Use when maintaining or diagnosing OpenCode
  itself.
---
...
Прочитай поле `plugin` из активного `opencode.json`. Для каждого указанного плагина:

- определи установленную и актуальную версии;
- собери changelog между ними из release notes, GitHub compare/commits, npm diff или официальной документации;
- выдели фичи, багфиксы, breaking changes и риски совместимости с текущей или целевой версией OpenCode;
- явно укажи результат проверки в итоговом брифе.

Не выдавай итоговый вердикт, пока каждый настроенный плагин не проверен или не отмечен как непроверяемый с указанием причины.
