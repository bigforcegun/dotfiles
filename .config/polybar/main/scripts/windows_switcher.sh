...
FILE="$HOME/.config/polybar/main/scripts/rofi/colors.rasi"
...
rofi -no-config -no-lazy-grab -show window -modi window -theme ~/.config/polybar/main/scripts/rofi/launcher.rasi
